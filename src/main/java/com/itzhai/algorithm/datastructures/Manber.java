package com.itzhai.algorithm.datastructures;

/**
 * 后缀数组-倍增算法实现
 * https://notes.mengxin.science/2018/12/08/suffix-array-and-lcp-theory-application/
 *
 * Created by arthinking on 24/4/2020.
 */
/******************************************************************************
...
//		String s = System.in.read().replaceAll("\\s+", " ").trim();
		String s = "arthinking";
		Manber suffix = new Manber(s);

		System.out.println("   i  ind     select");
		System.out.println("------------------------");
